...
def cleanText(text, alphabet="abcdefghijklmnopqrstuvwxyz"):
    ...
    if 'È' not in alphabet:
        text = text.replace("È", "E").replace("Ê", "E").replace("Ë", "E").replace("É", "E")
    if 'Ç' not in alphabet:
        text = text.replace("Ç", "C")
    if 'Ù' not in alphabet:
        text = text.replace("Û", "U").replace("Ü", "U").replace("Ù", "U")
...
def formatage(text, alphabet="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", ischiffre=True):
    text2 = ""
    ...
    if ans == "1":
        ...
        while choix:
            ...
            if choix == "1":
                ...
                text = input("Donner votre texte à déchiffrer:\n")
                print("\nle texte déchiffré est : "+dechiffavecCi(text))
            elif choix == "6":
                choixAlphabet = True
                while choixAlphabet:
                    print("""
